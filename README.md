...
| Popularity               | 0.004             | 0.000             | 0.000             | 0.000             | 0.000             | 0.001             | 0.003             | 0.000             | 0.000             | 0.000             | 0.000             | 0\input{tables/ranking_c2j_v2}.001 | 0.001             | 0.000             | 0.000             | 0.001             |
...
| Logistic reg.            | \textbf{0.283}    | \textbf{0.177}    | \textbf{0.079}    | \textbf{0.050}    | \textbf{0.177}    | \textbf{0.393}    | \textbf{0.503}    | \textbf{0.177}    | \textbf{0.131}    | \textbf{0.092}    | \textbf{0.177}    | \textbf{0.289}                     | \textbf{0.325}    | \textbf{0.177}    | \textbf{0.255}    | \textbf{0.269}    |
| -LLM feat.               | \underline{0.276} | \underline{0.176} | \underline{0.076} | 0.048             | \underline{0.176} | \underline{0.379} | 0.477             | \underline{0.176} | \underline{0.126} | 0.087             | \underline{0.176} | \underline{0.281}                  | \underline{0.313} | \underline{0.176} | \underline{0.249} | \underline{0.262} |
...
| Random forest            | 0.256             | 0.144             | \underline{0.076} | \underline{0.049} | 0.144             | 0.378             | \underline{0.491} | 0.144             | \underline{0.126} | \underline{0.089} | 0.144             | 0.265                              | 0.301             | 0.144             | 0.227             | 0.242             |
...
| -LLM feat.           | \underline{0.064} | \textbf{0.034}    | \underline{0.017} | \underline{0.012} | \textbf{0.034}    | \underline{0.086} | \underline{0.124} | \textbf{0.034}    | \underline{0.029} | \underline{0.022} | \textbf{0.034}    | \underline{0.061} | \underline{0.073} | \textbf{0.034}    | \underline{0.052} | \underline{0.057} |
...
| Random Forest        | \textbf{0.078}    | \underline{0.033} | \textbf{0.023}    | \textbf{0.017}    | \underline{0.033} | \textbf{0.114}    | \textbf{0.169}    | \underline{0.033} | \textbf{0.038}    | \textbf{0.031}    | \underline{0.033} | \textbf{0.074}    | \textbf{0.091}    | \underline{0.033} | \textbf{0.060}    | \textbf{0.068}    |
